cask "kicad@5.1" do
  ...
  app "KiCad/kicad.app",            target: "KiCad 5.1/kicad.app"
  app "KiCad/bitmap2component.app", target: "KiCad 5.1/bitmap2component.app"
  app "KiCad/eeschema.app",         target: "KiCad 5.1/eeschema.app"
  app "KiCad/gerbview.app",         target: "KiCad 5.1/gerbview.app"
  app "KiCad/pcb_calculator.app",   target: "KiCad 5.1/pcb_calculator.app"
  app "KiCad/pcbnew.app",           target: "KiCad 5.1/pcbnew.app"
  app "KiCad/pl_editor.app",        target: "KiCad 5.1/pl_editor.app"
